...
SUFFIX_RACE_MAP: list[tuple[str, list[str]]] = [
    ...
    ("_ug23@ashoka.edu.in",   ["president", "gensec", "council_late_grad"]),
    ("_ug24@ashoka.edu.in",   ["president", "gensec", "council_late_grad"]),
    ("_ug25@ashoka.edu.in",   ["president", "gensec", "council_late_grad"]),
    ("_ma2023@ashoka.edu.in", ["president", "gensec"]),
    ("_ma2024@ashoka.edu.in", ["president", "gensec"]),
    ("_ma2025@ashoka.edu.in", ["president", "gensec"]),
    ("_ma2026@ashoka.edu.in", ["president", "gensec"]),
    ("_msc2024@ashoka.edu.in",["president", "gensec"]),
    ("_phd18@ashoka.edu.in",  ["president", "gensec"]),
    ("_phd19@ashoka.edu.in",  ["president", "gensec"]),
    ("_phd20@ashoka.edu.in",  ["president", "gensec"]),
    ...
    ("_phd26@ashoka.edu.in",  ["president", "gensec"]),
    ...
    ("_asp25@ashoka.edu.in",  ["president", "gensec", "council_late_grad"]),
    ("_asp26@ashoka.edu.in",  ["president", "gensec", "council_late_grad"]),
    ("_asp27@ashoka.edu.in",  ["president", "gensec", "council_late_grad"]),
